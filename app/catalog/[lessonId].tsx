...
export default function CatalogLessonScreen() {
  ...
  const { completedCatalogLessonIds, completeCatalogLesson, catalogCompletedCount } = useTradeWise();
