      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            ...
            <Pressable onPress={() => { haptic.light(); router.push("/market-lab" as never); }} style={({ pressed }) => [styles.labLink, pressed && styles.pressed]}><View><Text style={styles.labLabel}>SYNTHETIC SCENARIOS</Text><Text style={styles.labTitle}>Open Market Lab</Text><Text style={styles.labDetail}>Practice trend, pullback, and range conditions with no real data.</Text></View><Text style={styles.labArrow}>›</Text></Pressable>
            <Pressable onPress={() => { haptic.light(); router.push("/stocks" as never); }} style={({ pressed }) => [styles.explorerLink, pressed && styles.pressed]}><View><Text style={styles.explorerLabel}>NEW · FICTIONAL COMPANY CASES</Text><Text style={styles.explorerTitle}>Explore synthetic stocks</Text><Text style={styles.explorerDetail}>Read charts, metrics, risks, and research questions across multiple sectors.</Text></View><Text style={styles.explorerArrow}>›</Text></Pressable>
...
const styles = StyleSheet.create({
  ...
  explorerLink: { backgroundColor: "#E8F4F1", borderRadius: 18, padding: 16, marginTop: 1, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  explorerLabel: { color: "#007C78", fontSize: 10, letterSpacing: 0.75, fontWeight: "800" },
  explorerTitle: { color: "#10243E", fontSize: 17, fontWeight: "800", marginTop: 4 },
  explorerDetail: { color: "#526276", fontSize: 12, lineHeight: 17, marginTop: 3 },
  explorerArrow: { color: "#007C78", fontSize: 26, fontWeight: "700", paddingLeft: 10 },
